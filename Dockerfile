...
# Download checkpoint + text encoder + upscalers (parallel)
RUN cd /comfyui/models && \
    wget -q -O checkpoints/ltx-2-19b-dev-fp8.safetensors \
      https://huggingface.co/Lightricks/LTX-2/resolve/main/ltx-2-19b-dev-fp8.safetensors & \
    wget -q -O clip/gemma_3_12B_it_fp8_scaled.safetensors \
...
# Download distilled + I2V adapter + IC LoRAs (parallel)
