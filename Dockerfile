...
RUN comfy model download --url https://huggingface.co/Comfy-Org/ltx-2/blob/main/split_files/text_encoders/gemma_3_12B_it_fp8_scaled.safetensors --relative-path models/clip --filename gemma_3_12B_it_fp8_scaled.safetensors
